cmd_arch/arm/mm/mm-armv.o := /usr/local/arm/3.4.1/bin/arm-linux-gcc -Wp,-MD,arch/arm/mm/.mm-armv.o.d  -nostdinc -isystem /usr/local/arm/3.4.1/lib/gcc/arm-linux/3.4.1/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fno-omit-frame-pointer -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mapcs-32 -D__LINUX_ARM_ARCH__=4 -march=armv4 -mtune=arm9tdmi -malignment-traps -msoft-float -Uarm -Wdeclaration-after-statement     -DKBUILD_BASENAME=mm_armv -DKBUILD_MODNAME=mm_armv -c -o arch/arm/mm/mm-armv.o arch/arm/mm/mm-armv.c

deps_arch/arm/mm/mm-armv.o := \
...
arch/arm/mm/mm-armv.o: $(deps_arch/arm/mm/mm-armv.o)
