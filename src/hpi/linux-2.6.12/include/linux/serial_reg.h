...
#ifdef CONFIG_ARCH_SMDK2410	//add by zzm

#define UART_DLM	(1<<1)	/* Out: Divisor Latch High (DLAB=1) */
#define UART_IER	(1<<1)	/* Out: Interrupt Enable Register */
#define UART_FCTR	(1<<1)	/* (LCR=BF) Feature Control Register
			 	 * XR16C85x only */

#define UART_IIR	(2<<1)	/* In:  Interrupt ID Register */
#define UART_FCR	(2<<1)	/* Out: FIFO Control Register */
#define UART_EFR	(2<<1)	/* I/O: Extended Features Register */
				/* (DLAB=1, 16C660 only) */

#define UART_LCR	(3<<1)	/* Out: Line Control Register */
#define UART_MCR	(4<<1)	/* Out: Modem Control Register */
#define UART_LSR	(5<<1)	/* In:  Line Status Register */
#define UART_MSR	(6<<1)	/* In:  Modem Status Register */
#define UART_SCR	(7<<1)	/* I/O: Scratch Register */
#define UART_EMSR	(7<<1)	/* (LCR=BF) Extended Mode Select Register 
