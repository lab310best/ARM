cmd_lib/zlib_inflate/infcodes.o := /usr/local/arm/3.4.1/bin/arm-linux-gcc -Wp,-MD,lib/zlib_inflate/.infcodes.o.d  -nostdinc -isystem /usr/local/arm/3.4.1/lib/gcc/arm-linux/3.4.1/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fno-omit-frame-pointer -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mapcs-32 -D__LINUX_ARM_ARCH__=4 -march=armv4 -mtune=arm9tdmi -malignment-traps -msoft-float -Uarm -Wdeclaration-after-statement     -DKBUILD_BASENAME=infcodes -DKBUILD_MODNAME=zlib_inflate -c -o lib/zlib_inflate/infcodes.o lib/zlib_inflate/infcodes.c

deps_lib/zlib_inflate/infcodes.o := \
...
lib/zlib_inflate/infcodes.o: $(deps_lib/zlib_inflate/infcodes.o)
