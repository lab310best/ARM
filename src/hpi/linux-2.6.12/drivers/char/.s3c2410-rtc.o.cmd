cmd_drivers/char/s3c2410-rtc.o := /usr/local/arm/3.4.1/bin/arm-linux-gcc -Wp,-MD,drivers/char/.s3c2410-rtc.o.d  -nostdinc -isystem /usr/local/arm/3.4.1/lib/gcc/arm-linux/3.4.1/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fno-omit-frame-pointer -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mapcs-32 -D__LINUX_ARM_ARCH__=4 -march=armv4 -mtune=arm9tdmi -malignment-traps -msoft-float -Uarm -Wdeclaration-after-statement     -DKBUILD_BASENAME=s3c2410_rtc -DKBUILD_MODNAME=s3c2410_rtc -c -o drivers/char/s3c2410-rtc.o drivers/char/s3c2410-rtc.c

deps_drivers/char/s3c2410-rtc.o := \
...
drivers/char/s3c2410-rtc.o: $(deps_drivers/char/s3c2410-rtc.o)
