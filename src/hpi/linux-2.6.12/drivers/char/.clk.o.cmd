cmd_drivers/char/clk.o := /usr/local/arm/3.4.1/bin/arm-linux-gcc -Wp,-MD,drivers/char/.clk.o.d  -nostdinc -isystem /usr/local/arm/3.4.1/lib/gcc/arm-linux/3.4.1/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fno-omit-frame-pointer -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mapcs-32 -D__LINUX_ARM_ARCH__=4 -march=armv4 -mtune=arm9tdmi -malignment-traps -msoft-float -Uarm -Wdeclaration-after-statement    -DMODULE -DKBUILD_BASENAME=clk -DKBUILD_MODNAME=clk -c -o drivers/char/clk.o drivers/char/clk.c

deps_drivers/char/clk.o := \
  drivers/char/clk.c \
...
drivers/char/clk.o: $(deps_drivers/char/clk.o)
