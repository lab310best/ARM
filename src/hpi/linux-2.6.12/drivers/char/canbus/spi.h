...
#define CHIP_SELECT_nSS0				0xFFFFFFBF       //by feiling
#define CHIP_DESELECT_nSS0				0x00000040      //by feiling
...
#define ENABLE_SPIMSIO					0x02800000  //SPIÊä³öºÍÊäÈë
#define DISABLE_SPICLK_SPIMSIO_PULLUP			0x00003800
#define TEST						0x00003800
