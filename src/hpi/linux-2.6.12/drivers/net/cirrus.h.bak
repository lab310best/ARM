...
/* -------------------- Set Hardware Capabilities for FS2410 -------------- */

#elif defined(CONFIG_ARCH_S3C2410)
#include <asm/arch/regs-irq.h>
//#include <asm/arch-s3c2410/smdk.h>
...
#define CIRRUS_inw(a, r)		readw((a) + (r))
#define CIRRUS_outw(v, a, r)		writew(v, (a) + (r))
#define CIRRUS_insw(a, r, p, l)		insw((a) + (r), p, l)
#define CIRRUS_outsw(a, r, p, l)	outsw((a) + (r), p, l)

#define CIRRUS_IOADDR			(S3C2410_VA_CS8900 + 0x300)
#define CIRRUS_IRQ			IRQ_EINT9//IRQ_CS8900
