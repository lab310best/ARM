cmd_drivers/video/logo/logo.o := /usr/local/arm/3.4.1/bin/arm-linux-gcc -Wp,-MD,drivers/video/logo/.logo.o.d  -nostdinc -isystem /usr/local/arm/3.4.1/lib/gcc/arm-linux/3.4.1/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fno-omit-frame-pointer -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mapcs-32 -D__LINUX_ARM_ARCH__=4 -march=armv4 -mtune=arm9tdmi -malignment-traps -msoft-float -Uarm -Wdeclaration-after-statement     -DKBUILD_BASENAME=logo -DKBUILD_MODNAME=logo -c -o drivers/video/logo/logo.o drivers/video/logo/logo.c
...
deps_drivers/video/logo/logo.o := \
  drivers/video/logo/logo.c \
    ...
    $(wildcard include/config/logo/linux/tft16.h) \
