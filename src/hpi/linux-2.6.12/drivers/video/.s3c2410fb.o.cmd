cmd_drivers/video/s3c2410fb.o := /usr/local/arm/3.4.1/bin/arm-linux-gcc -Wp,-MD,drivers/video/.s3c2410fb.o.d  -nostdinc -isystem /usr/local/arm/3.4.1/lib/gcc/arm-linux/3.4.1/include -D__KERNEL__ -Iinclude  -mlittle-endian -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fno-omit-frame-pointer -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mapcs-32 -D__LINUX_ARM_ARCH__=4 -march=armv4 -mtune=arm9tdmi -malignment-traps -msoft-float -Uarm -Wdeclaration-after-statement     -DKBUILD_BASENAME=s3c2410fb -DKBUILD_MODNAME=s3c2410fb -c -o drivers/video/s3c2410fb.o drivers/video/s3c2410fb.c

deps_drivers/video/s3c2410fb.o := \
  drivers/video/s3c2410fb.c \
    $(wildcard include/config/fb/pxa/parameters.h) \
    $(wildcard include/config/fb/s3c2410/800x600.h) \
    $(wildcard include/config/fb/s3c2410/640x480.h) \
    $(wildcard include/config/fb/s3c2410/240x320/sharp.h) \
    $(wildcard include/config/fb/s3c2410/640x480/sharp.h) \
    $(wildcard include/config/fb/s3c2410/240x320/samsung.h) \
    $(wildcard include/config/cpu/freq.h) \
    $(wildcard include/config/s3c2410/smdk.h) \
    $(wildcard include/config/smdk/aiji.h) \
