...
(info->enable_oc)(info, 1); 
 ...
 printk(KERN_ERR "CLKDIVN = %08x\nCLKSLOW = %08x\nCLKCON = %08x\nUPLLCON = %08x\n",__raw_readl(S3C2410_CLKDIVN),__raw_readl(S3C2410_CLKSLOW),__raw_readl(S3C2410_CLKCON),__raw_readl(S3C2410_UPLLCON));
} 
...
//printk(KERN_ERR "line %d passed,in ohci_s3c2410_status_data \
  //info return from to_s3c2410_info() is %#p \n",__LINE__,info);
...
{ 
  printk (KERN_ERR "hello,enter new ohci-s3c2410.c\n");
